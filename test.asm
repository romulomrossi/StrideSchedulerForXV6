...
main(void)
{
  ...
  24:	e8 47 00 00 00       	call   70 <new_fork>
...
{ 
  30:	55                   	push   %ebp
    ...
    return a < 0 ? -1*a : a;
  31:	ba 33 01 00 90       	mov    $0x90000133,%edx
...
{ 
  36:	89 e5                	mov    %esp,%ebp
    unsigned long a = ((unsigned long)b * 279470273UL) % 42949671UL;
    return a < 0 ? -1*a : a;
  38:	69 4d 08 c1 60 a8 10 	imul   $0x10a860c1,0x8(%ebp),%ecx
}
  3f:	5d                   	pop    %ebp
...
{ 
  ...
  4c:	c1 e8 19             	shr    $0x19,%eax
  4f:	69 c0 27 5c 8f 02    	imul   $0x28f5c27,%eax,%eax
...
void new_fork(unsigned int tickets){
    ...
    if(counter >=  N)
  70:	a1 04 0b 00 00       	mov    0xb04,%eax
  75:	83 f8 09             	cmp    $0x9,%eax
  78:	7e 02                	jle    7c <new_fork+0xc>
  7a:	f3 c3                	repz ret 
  wait_(seed);
}
...
void new_fork(unsigned int tickets){
  ...
  85:	83 ec 18             	sub    $0x18,%esp
    ...
    counter++;
  88:	a3 04 0b 00 00       	mov    %eax,0xb04
    int pid = fork(1);
  8d:	6a 01                	push   $0x1
  8f:	e8 b6 02 00 00       	call   34a <fork>
  ...
  9b:	57                   	push   %edi
  9c:	e8 59 03 00 00       	call   3fa <cht>
    if(pid == 0){
  a1:	83 c4 10             	add    $0x10,%esp
  a4:	83 ff 00             	cmp    $0x0,%edi
  a7:	74 45                	je     ee <new_fork+0x7e>
  a9:	be f4 03 00 00       	mov    $0x3f4,%esi
      new_fork(tickets+100);
    }
    if(pid > 0){
  ae:	7e 24                	jle    d4 <new_fork+0x64>
  wait_(seed);
}
...
void new_fork(unsigned int tickets){
  b0:	bb 05 36 00 00       	mov    $0x3605,%ebx
  ...
  cd:	75 e9                	jne    b8 <new_fork+0x48>
    ...
    if(pid > 0){
        for(int i = 0; i < 1012; i++){
  cf:	83 ee 01             	sub    $0x1,%esi
  d2:	75 dc                	jne    b0 <new_fork+0x40>
          for(int j = 0; j < 13829; j++){
             printf(1, "");
          }
        }
  ...
  d4:	ff 75 08             	pushl  0x8(%ebp)
  d7:	57                   	push   %edi
  d8:	68 d8 07 00 00       	push   $0x7d8
  dd:	6a 01                	push   $0x1
  df:	e8 cc 03 00 00       	call   4b0 <printf>
    wait();
  e4:	e8 71 02 00 00       	call   35a <wait>
    exit();
  e9:	e8 64 02 00 00       	call   352 <exit>
  ...
  f4:	83 c0 64             	add    $0x64,%eax
  f7:	50                   	push   %eax
  f8:	e8 73 ff ff ff       	call   70 <new_fork>
  fd:	83 c4 10             	add    $0x10,%esp
 100:	eb d2                	jmp    d4 <new_fork+0x64>
...
putc(int fd, char c)
{
 ...
 5c8:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
          s = "(null)";
 5cb:	b8 00 08 00 00       	mov    $0x800,%eax
...
free(void *ap)
{
 ...
 6a7:	89 08                	mov    %ecx,(%eax)
  freep = p;
 6a9:	a3 08 0b 00 00       	mov    %eax,0xb08
}
 6ae:	5b                   	pop    %ebx
 6af:	5e                   	pop    %esi
 6b0:	5f                   	pop    %edi
 ...
 6ca:	03 53 fc             	add    -0x4(%ebx),%edx
    ...
    p->s.ptr = bp;
  freep = p;
 6cd:	a3 08 0b 00 00       	mov    %eax,0xb08
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
...
malloc(uint nbytes)
{
 ...
 73f:	76 3f                	jbe    780 <malloc+0xa0>
    ...
    if(p == freep)
 741:	39 05 08 0b 00 00    	cmp    %eax,0xb08
 ...
 766:	e8 e5 fe ff ff       	call   650 <free>
  return freep;
 76b:	8b 15 08 0b 00 00    	mov    0xb08,%edx
      }
      freep = prevp;
      return (void*)(p + 1);
    }
 ...
 7a4:	eb e9                	jmp    78f <malloc+0xaf>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 7a6:	c7 05 08 0b 00 00 0c 	movl   $0xb0c,0xb08
 7ad:	0b 00 00 
 7b0:	c7 05 0c 0b 00 00 0c 	movl   $0xb0c,0xb0c
 7b7:	0b 00 00 
    base.s.size = 0;
 7ba:	b8 0c 0b 00 00       	mov    $0xb0c,%eax
 7bf:	c7 05 10 0b 00 00 00 	movl   $0x0,0xb10
 7c6:	00 00 00 
