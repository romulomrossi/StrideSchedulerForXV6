...
main(void)
{
  ...
  exit();
  29:	e8 54 03 00 00       	call   382 <exit>
  2e:	66 90                	xchg   %ax,%ax
...
{ 
  ...
  30:	8b 0d 30 0b 00 00    	mov    0xb30,%ecx
    return a < 0 ? -1*a : a;
...
{ 
    unsigned long a = ((unsigned long)next++ * 279470273UL) % 42949671UL;
  47:	a3 30 0b 00 00       	mov    %eax,0xb30
    return a < 0 ? -1*a : a;
}
  4c:	5d                   	pop    %ebp
...
void new_fork(unsigned int tickets){
    ...
    if(counter >=  N)
  80:	a1 34 0b 00 00       	mov    0xb34,%eax
...
void new_fork(unsigned int tickets){
  ...
  95:	83 ec 18             	sub    $0x18,%esp
    ...
    counter++;
  98:	a3 34 0b 00 00       	mov    %eax,0xb34
    int pid = fork(-1);
  9d:	6a ff                	push   $0xffffffff
  9f:	e8 d6 02 00 00       	call   37a <fork>
  ...
  ab:	57                   	push   %edi
  ac:	e8 79 03 00 00       	call   42a <cht>
    if(pid == 0){
  b1:	83 c4 10             	add    $0x10,%esp
  b4:	83 ff 00             	cmp    $0x0,%edi
  b7:	74 4c                	je     105 <new_fork+0x85>
  b9:	be 10 27 00 00       	mov    $0x2710,%esi
      new_fork(lcg_rand()%200);
    }
    if(pid > 0){
  be:	7e 24                	jle    e4 <new_fork+0x64>
  wait_(seed);
}
...
void new_fork(unsigned int tickets){
  c0:	bb 15 97 f6 42       	mov    $0x42f69715,%ebx
  ...
  dd:	75 e9                	jne    c8 <new_fork+0x48>
    ...
    if(pid > 0){
        for(int i = 0; i < 10000; i++){
  df:	83 ee 01             	sub    $0x1,%esi
  e2:	75 dc                	jne    c0 <new_fork+0x40>
#define N 10
...
{ 
    unsigned long a = ((unsigned long)next++ * 279470273UL) % 42949671UL;
  e4:	83 05 30 0b 00 00 01 	addl   $0x1,0xb30
             printf(1, "");
          }
        }
    }
    wait_(lcg_rand());
    wait();
  eb:	e8 9a 02 00 00       	call   38a <wait>
    printf(1, "Returning Pid >>>> %d with %d tickets\n", pid, tickets);
  f0:	ff 75 08             	pushl  0x8(%ebp)
  f3:	57                   	push   %edi
...
{ 
    unsigned long a = ((unsigned long)next++ * 279470273UL) % 42949671UL;
 105:	a1 30 0b 00 00       	mov    0xb30,%eax
    ...
    if(pid == 0){
      new_fork(lcg_rand()%200);
 10a:	b9 27 5c 8f 02       	mov    $0x28f5c27,%ecx
...
{ 
 ...
 112:	8d 50 01             	lea    0x1(%eax),%edx
    ...
    if(pid == 0){
      new_fork(lcg_rand()%200);
 115:	69 c0 c1 60 a8 10    	imul   $0x10a860c1,%eax,%eax
#define N 10
...
{ 
    unsigned long a = ((unsigned long)next++ * 279470273UL) % 42949671UL;
 11b:	89 15 30 0b 00 00    	mov    %edx,0xb30
 ...
 123:	f7 f1                	div    %ecx
 125:	b9 c8 00 00 00       	mov    $0xc8,%ecx
 12a:	89 d0                	mov    %edx,%eax
 12c:	31 d2                	xor    %edx,%edx
 12e:	f7 f1                	div    %ecx
 130:	52                   	push   %edx
 131:	e8 4a ff ff ff       	call   80 <new_fork>
 136:	83 c4 10             	add    $0x10,%esp
 139:	eb a9                	jmp    e4 <new_fork+0x64>
...
00000440 <printint>:
 ...
 47f:	f7 f6                	div    %esi
 481:	0f b6 92 38 08 00 00 	movzbl 0x838(%edx),%edx
...
000004e0 <printf>:
 ...
 5fb:	b8 30 08 00 00       	mov    $0x830,%eax
...
free(void *ap)
{
 ...
 6d7:	89 08                	mov    %ecx,(%eax)
  freep = p;
 6d9:	a3 38 0b 00 00       	mov    %eax,0xb38
}
 6de:	5b                   	pop    %ebx
 6df:	5e                   	pop    %esi
 6e0:	5f                   	pop    %edi
 ...
 6fa:	03 53 fc             	add    -0x4(%ebx),%edx
    ...
    p->s.ptr = bp;
  freep = p;
 6fd:	a3 38 0b 00 00       	mov    %eax,0xb38
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
...
malloc(uint nbytes)
{
 ...
 719:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 71c:	8b 15 38 0b 00 00    	mov    0xb38,%edx
malloc(uint nbytes)
{
  Header *p, *prevp;
  uint nunits;
 ...
 76f:	76 3f                	jbe    7b0 <malloc+0xa0>
    ...
    if(p == freep)
 771:	39 05 38 0b 00 00    	cmp    %eax,0xb38
 ...
 796:	e8 e5 fe ff ff       	call   680 <free>
  return freep;
 79b:	8b 15 38 0b 00 00    	mov    0xb38,%edx
      }
      freep = prevp;
      return (void*)(p + 1);
    }
 ...
 7d4:	eb e9                	jmp    7bf <malloc+0xaf>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 7d6:	c7 05 38 0b 00 00 3c 	movl   $0xb3c,0xb38
 7dd:	0b 00 00 
 7e0:	c7 05 3c 0b 00 00 3c 	movl   $0xb3c,0xb3c
 7e7:	0b 00 00 
    base.s.size = 0;
 7ea:	b8 3c 0b 00 00       	mov    $0xb3c,%eax
 7ef:	c7 05 40 0b 00 00 00 	movl   $0x0,0xb40
 7f6:	00 00 00 
