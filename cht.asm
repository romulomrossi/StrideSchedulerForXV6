...
main (int argc, char **argv)
{
  ...
  42:	53                   	push   %ebx
  43:	56                   	push   %esi
  44:	e8 11 03 00 00       	call   35a <cht>
    exit();
  ...
  4e:	51                   	push   %ecx
  4f:	51                   	push   %ecx
  50:	68 30 07 00 00       	push   $0x730
  55:	6a 02                	push   $0x2
  57:	e8 b4 03 00 00       	call   410 <printf>
        exit();
  5c:	e8 51 02 00 00       	call   2b2 <exit>
  61:	66 90                	xchg   %ax,%ax
  63:	66 90                	xchg   %ax,%ax
  65:	66 90                	xchg   %ax,%ax
  67:	66 90                	xchg   %ax,%ax
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3af:	f7 f6                	div    %esi
 3b1:	0f b6 92 70 07 00 00 	movzbl 0x770(%edx),%edx
  }while((x /= base) != 0);
...
putc(int fd, char c)
{
 ...
 528:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
          s = "(null)";
 52b:	b8 68 07 00 00       	mov    $0x768,%eax
